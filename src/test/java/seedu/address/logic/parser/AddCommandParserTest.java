...
public class AddCommandParserTest {
    ...
    //     assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + ID_DESC_BOB + PHONE_DESC_BOB ,
    ...
    //                    + TAG_DESC_FRIEND + ID_DESC_BOB,
    //            new AddCommand(expectedPersonMultipleTags));
    // }

    @Test
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + ID_DESC_BOB + PHONE_DESC_BOB;
        ...
        //         validExpectedPersonString + PHONE_DESC_AMY + NAME_DESC_AMY + ID_DESC_AMY
        //                 //+ EMAIL_DESC_AMY + ADDRESS_DESC_AMY
        //                 + validExpectedPersonString,
        //         Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_ID, PREFIX_PHONE));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + ID_DESC_BOB + VALID_PHONE_BOB,
                //+ EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_ID_BOB + VALID_PHONE_BOB,
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        // assertParseFailure(parser, INVALID_NAME_DESC + ID_DESC_BOB + PHONE_DESC_BOB,
        //         //+ EMAIL_DESC_BOB + ADDRESS_DESC_BOB
        //         //+ TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        //         Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        // assertParseFailure(parser, NAME_DESC_BOB + ID_DESC_BOB + INVALID_PHONE_DESC,
        //          //+ EMAIL_DESC_BOB + ADDRESS_DESC_BOB
        //          //+ TAG_DESC_HUSBAND + TAG_DESC_FRIEND
        //          Phone.MESSAGE_CONSTRAINTS);

        // invalid id
        // assertParseFailure(parser, NAME_DESC_BOB + INVALID_ID_DESC + PHONE_DESC_BOB,
        //         //+ EMAIL_DESC_BOB + ADDRESS_DESC_BOB
        //         //+ TAG_DESC_HUSBAND + TAG_DESC_FRIEND
        ...
        // assertParseFailure(parser, INVALID_NAME_DESC + INVALID_ID_DESC + PHONE_DESC_BOB,
